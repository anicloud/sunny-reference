...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="http://localhost:8081/service-bus/oauth/authorize?client_id=1058595963104900977&redirect_uri=http://localhost:8080/sunny/redirect&response_type=code&scope=read write" class="btn btn-success">未授权,用Anicloud 账号登录</a>
            </div>
        </div>
    </div>
</body>
