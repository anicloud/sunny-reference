...
<body>
    ...
    <div class="">
        <div class="col-sm-12">
            <a href=" http://dev.anicloud.cn:8222/rect-manager/oauth/authorize?client_id=sunny-client&redirect_uri=http://192.168.1.19:8080/sunny/redirect&response_type=code&scope=read write" class="btn btn-primary">Use Anicloud Account to Login</a>
        </div>
    </div>
</body>
</html>
